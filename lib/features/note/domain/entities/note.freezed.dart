...
class _$NoteImpl implements _Note {
  ...
  @override
  String toString() {
    return 'Note(id: $id, title: $title, content: $content, createdOn: $createdOn, lastUpdated: $lastUpdated, kind: $kind, todos: $todos, folder: $folder, location: $location)';
  }
...
abstract class _Note implements Note {
  factory _Note(
      ...
      final List<int>? todos,
      final int? folder,
      required final Location location}) = _$NoteImpl;
